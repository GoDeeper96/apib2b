...
import { CambiarContraseña, CrearUsuario, EditarUsuario, EliminarUsuario, GetUsuarios, SearchUsuario } from "../controllers/usuarios/Usuario.controller.js";

const router = Router()
router.post('/getusuarios',protect,GetUsuarios) //RASTREABLE
router.post('/adduser',protect,CrearUsuario) //RASTREABLE
router.post('/searchusuario',protect,SearchUsuario)
